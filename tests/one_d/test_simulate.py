import numpy as np
from ot_regression.one_d.simulate import map_T, generate_pair, generate_dataset
...
def test_generate_dataset_shapes(grid_size):
    Xs, Ys, pair_maps = generate_dataset(num_pairs=3, samples_per_dist=300, grid_size=grid_size, seed=0)
